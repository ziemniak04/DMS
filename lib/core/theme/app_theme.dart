  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        color: cardColor,
        elevation: 0.5,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16), side: const BorderSide(color: dividerColor, width: 1)),
        surfaceTintColor: Colors.transparent,
      ),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        color: darkCardColor,
        elevation: 1,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16), side: const BorderSide(color: darkDividerColor, width: 0.5)),
        surfaceTintColor: Colors.transparent,
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
